<template>
  <div class="Scritte">
      ...
      <div v-if="posizioni.length == 0 && pareggio == false">
          <h1 class="titolo animate__animated animate__jackInTheBox">Gioca!</h1>
    ...
    <div v-if="posizioni.length != 0 || pareggio == true">
        <h1 class="titolo animate__animated animate__pulse" v-if="posizioni.length != 0">
            HA VINTO
            <br>
            <img src="@/assets/x.png" class="immagine animate__animated animate__pulse" v-if="simbolo=='X'">
            <img src="@/assets/O.png" class="immagine animate__animated animate__pulse" v-if="simbolo=='O'">
        </h1>
